...
from .models import UserProfile, Clinic, Note, CommunicationNote, ProcedureNote, InstructionNote, ResourceNote, SelfCareNote, Notebook, Attachment, NoteReply, Notification, AppointmentNote, ContactNote, MedicationNote, Address, Privacy
...
admin.site.register(MedicationNote)
