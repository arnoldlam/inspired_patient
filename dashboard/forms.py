...
class AddContactNoteForm(AddNoteForm):
	...
	organization_name = forms.CharField(label='Organization name', max_length=100, widget=forms.TextInput(attrs={'class':'form-control', 'required':'required'}))
	phone_number_work = forms.CharField(label='Work Phone', max_length=20, widget=forms.TextInput(attrs={'class':'form-control', 'required':'required'}))
	phone_number_home = forms.CharField(label='Home Phone', max_length=20, widget=forms.TextInput(attrs={'class':'form-control', 'required':'required'}))
